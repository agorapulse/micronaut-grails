...
class MicronautGrailsIntegrationTestMixinTransformation implements ASTTransformation {
    ...
    public static final ClassNode GRAILS_APPLICATION_CONTEXT_LOADER = ClassHelper.make(MicronautGrailsApplicationContextLoader)
    ...
    void visit(ASTNode[] astNodes, SourceUnit source) {
        ...
        if(applicationClassExpression) {
            ...
            if(!applicationClassNode.isDerivedFrom(ClassHelper.make(MicronautGrailsAutoConfiguration))) {
